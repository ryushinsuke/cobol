...
# 年月日    区分    所属    内容
# --------  ----    ------  --------------------------------------
# 20080919  新規    SCS     于瓊 　新規作成
# 20110414  修正    SCS     余少林 テーマ3212-1
#
...
#-----------------------------------------------------------------------------------------
# ステップ-0030 残高・損益更新メイン
#-----------------------------------------------------------------------------------------
TS_STEPID=0030
BCZC1100.sh ${TS_STEPID}                                                                     >> $TS_LOGFILE
echo "*********************************************************************"                 >> $TS_LOGFILE
echo "*************************残高・損益更新メイン************************"                 >> $TS_LOGFILE
...
echo "MMZJ4010 ${TS_RIYO_CMPCD} ${SJ_PEX_DATE} ${TS_KIDOID} ${TS_EXECID} "                      >> $TS_LOGFILE

MMZJ4010 ${TS_RIYO_CMPCD} ${SJ_PEX_DATE} ${TS_KIDOID} ${TS_EXECID}                              >> $TS_LOGFILE  2>&1
TS_STATUS=$?
echo "MMZJ4010 戻り値＝${TS_STATUS}"                                                            >> $TS_LOGFILE
case $TS_STATUS in
#正常
